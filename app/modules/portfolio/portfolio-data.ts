  ...
  projects: [
    {
      ...
      description:
        "The first open-source plugin to support dynamic color settings for multi themes on tailwindcss. Reached 1300+ downloads in the first week of public release of version 1.0",
    ...
    },
    {
      ...
      title: "React-tvcx",
      description:
        "A library that provides functions to help users create a reusable component system for their projects using React, Tailwind CSS, and TypeScript. It simplifies the creation and management of components with support for variant styles and context-based slot management.",
    ...
    },
    {
      ...
      title: "MojaUI React",
      description:
        "Open-source reusable UI library built on TailwindCSS and Ark-UI. A comprehensive component library for modern React applications.",
    ...
    },
    {
      ...
      title: "ONUS Chain",
      description:
        "ETH layer2 blockchain network partners with ONUS. Developed the UI for block explorer, landing page, and various blockchain interfaces.",
    ...
    },
    {
      ...
      title: "Mcity",
      description:
        "Metaverse project releases tokens and NFT on BSC network. Mainly responsible for developing the project's dapps and user interfaces.",
  ...
  experience: [
    {
      ...
      location: "Hanoi, Vietnam",
      description:
        "Specializing in providing frontend technical solutions for various clients. Focus on modern web development technologies and best practices.",
    ...
    },
    {
      ...
      location: "Vietnam",
      description:
        "Head of frontend development team. Provided and ensured frontend technical quality of the company's main products including GameFi, DeFi, Quest-to-earn, Move-to-earn, AMM Dex, and CEX platforms.",
    ...
    },
    {
      ...
      location: "Vietnam",
      description:
        "Participated in developing outsourcing projects for public and private enterprises. Focused on building user interfaces and fixing bugs for various client projects.",
  ...
  education: [
    {
      ...
      location: "Vietnam",
      description:
        "Studied software engineering with focus on modern development practices and technologies.",
    },
  ],
  config: {
    theme: "minimal",
