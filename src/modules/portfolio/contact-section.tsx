...
export function ContactSection({
	...
	return (
		<section id="contact" className="bg-linear-to-b from-muted/30 to-bg py-24">
								...
								<div className="space-y-4">
									...
									{profile.phone && (
										<a
											...
											className="group flex items-center gap-4 rounded-lg border border-border bg-muted/50 p-4 transition-all duration-300 hover:translate-x-2 hover:border-primary hover:bg-primary/5"
										>
									...
									{/* Location */}
									<div className="flex items-center gap-4 rounded-lg border border-border bg-muted/50 p-4 transition-all duration-300 hover:translate-x-2">
