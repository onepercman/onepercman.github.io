...
const Preloader = () => {
	...
	return (
		<div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
			...
			<p className="name-text -translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 flex overflow-hidden text-center font-anton font-black text-[10vw] leading-none lg:text-[100px]">
